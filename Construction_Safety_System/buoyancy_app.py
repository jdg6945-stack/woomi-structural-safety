...
with c_img1:
    ...
    st.image(overlay_text(os.path.join(os.path.dirname(__file__), "plan.png"), [((550, 30), x_dist, False), ((30, 500), y_dist, True)]), use_container_width=True)
with c_img2:
...
with ld_c3:
    with st.container(border=True):
        ...
        t_slab_bot = st.number_input("내수압슬래브 두께 (mm)", value=400, key="ld_t_slab_bot")
